...
export const mealTemplates: MealTemplate[] = [
  ...
  // Replacements for templates removed for containing non-kosher animals
  // (pork/bacon/ham/prosciutto/salami, and shellfish — shrimp/prawns/crab/
  // mussels/scallops) — keeps every (mealType, diet) cell back at 10.
  { id: 'b41', mealType: 'Breakfast', diet: 'pescatarian', name: 'Baked Salmon & Egg Bites', baseCalories: 420, baseProtein: 32, baseCarbs: 10, baseFat: 27,
    baseItems: [{ food: 'Salmon fillet', qty: '120g' }, { food: 'Whole eggs', qty: '3' }, { food: 'Spinach', qty: '50g' }, { food: 'Feta cheese', qty: '20g' }] },
  { id: 'b42', mealType: 'Breakfast', diet: 'pescatarian', name: 'Herring & Rye Toast', baseCalories: 400, baseProtein: 26, baseCarbs: 34, baseFat: 18,
    baseItems: [{ food: 'Pickled herring', qty: '100g' }, { food: 'Rye toast', qty: '60g' }, { food: 'Cream cheese', qty: '20g' }] },
  { id: 'b43', mealType: 'Breakfast', diet: 'omnivore', name: 'Turkey Sausage & Egg Scramble', baseCalories: 440, baseProtein: 32, baseCarbs: 18, baseFat: 26,
    baseItems: [{ food: 'Turkey sausage', qty: '120g' }, { food: 'Whole eggs', qty: '2' }, { food: 'Bell pepper', qty: '50g' }, { food: 'Onion', qty: '30g' }] },
  { id: 'b44', mealType: 'Breakfast', diet: 'omnivore', name: 'Grilled Chicken Breakfast Bowl', baseCalories: 460, baseProtein: 40, baseCarbs: 34, baseFat: 16,
    baseItems: [{ food: 'Grilled chicken breast', qty: '150g' }, { food: 'Whole eggs', qty: '1' }, { food: 'Sweet potato', qty: '120g' }, { food: 'Spinach', qty: '50g' }] },
  { id: 'b45', mealType: 'Breakfast', diet: 'omnivore', name: 'Beef Sausage & Veggie Hash', baseCalories: 470, baseProtein: 30, baseCarbs: 36, baseFat: 22,
    baseItems: [{ food: 'Lean beef sausage', qty: '130g' }, { food: 'Bell pepper', qty: '60g' }, { food: 'Sweet potato', qty: '150g' }] },
  { id: 'b46', mealType: 'Breakfast', diet: 'omnivore', name: 'Lamb & Egg Breakfast Wrap', baseCalories: 490, baseProtein: 32, baseCarbs: 30, baseFat: 26,
    baseItems: [{ food: 'Ground lamb', qty: '120g' }, { food: 'Whole eggs', qty: '2' }, { food: 'Spinach', qty: '50g' }, { food: 'Whole-wheat wrap', qty: '1' }] },
  { id: 'b47', mealType: 'Breakfast', diet: 'omnivore', name: 'Turkey & Avocado Breakfast Bowl', baseCalories: 450, baseProtein: 34, baseCarbs: 28, baseFat: 22,
    baseItems: [{ food: 'Sliced turkey breast', qty: '120g' }, { food: 'Whole eggs', qty: '1' }, { food: 'Avocado', qty: '60g' }, { food: 'Whole-grain toast', qty: '40g' }] },
  { id: 'l41', mealType: 'Lunch', diet: 'omnivore', name: 'Grilled Lamb Kofta & Rice', baseCalories: 600, baseProtein: 40, baseCarbs: 56, baseFat: 22,
    baseItems: [{ food: 'Ground lamb kofta', qty: '170g' }, { food: 'Basmati rice, cooked', qty: '150g' }, { food: 'Cucumber-tomato salad', qty: '100g' }] },
  { id: 'l42', mealType: 'Lunch', diet: 'omnivore', name: 'Beef & Sweet Potato Bowl', baseCalories: 570, baseProtein: 42, baseCarbs: 54, baseFat: 18,
    baseItems: [{ food: 'Lean beef strips', qty: '170g' }, { food: 'Sweet potato', qty: '180g' }, { food: 'Kale', qty: '70g' }] },
  { id: 'l43', mealType: 'Lunch', diet: 'pescatarian', name: 'Grilled Salmon & Quinoa Salad', baseCalories: 560, baseProtein: 40, baseCarbs: 44, baseFat: 22,
    baseItems: [{ food: 'Salmon fillet', qty: '160g' }, { food: 'Quinoa, cooked', qty: '150g' }, { food: 'Cherry tomatoes', qty: '60g' }, { food: 'Cucumber', qty: '60g' }] },
  { id: 'l44', mealType: 'Lunch', diet: 'pescatarian', name: 'Baked Cod Tacos', baseCalories: 520, baseProtein: 38, baseCarbs: 54, baseFat: 13,
    baseItems: [{ food: 'Cod fillet', qty: '170g' }, { food: 'Corn tortillas', qty: '3' }, { food: 'Cabbage slaw', qty: '80g' }] },
  { id: 'l45', mealType: 'Lunch', diet: 'pescatarian', name: 'Tuna & White Bean Salad', baseCalories: 500, baseProtein: 42, baseCarbs: 38, baseFat: 16,
    baseItems: [{ food: 'Tuna, canned in water', qty: '160g' }, { food: 'White beans, cooked', qty: '120g' }, { food: 'Mixed greens', qty: '80g' }, { food: 'Olive oil', qty: '10g' }] },
  { id: 'l46', mealType: 'Lunch', diet: 'pescatarian', name: 'Grilled Mahi Mahi & Rice', baseCalories: 540, baseProtein: 42, baseCarbs: 50, baseFat: 16,
    baseItems: [{ food: 'Mahi mahi fillet', qty: '180g' }, { food: 'Brown rice, cooked', qty: '150g' }, { food: 'Grilled vegetables', qty: '120g' }] },
  { id: 'l47', mealType: 'Lunch', diet: 'pescatarian', name: 'Herb-Crusted Tilapia & Quinoa', baseCalories: 510, baseProtein: 40, baseCarbs: 46, baseFat: 14,
    baseItems: [{ food: 'Tilapia fillet', qty: '180g' }, { food: 'Quinoa, cooked', qty: '150g' }, { food: 'Steamed broccoli', qty: '100g' }] },
  { id: 'd41', mealType: 'Dinner', diet: 'pescatarian', name: 'Grilled Salmon & Asparagus', baseCalories: 590, baseProtein: 42, baseCarbs: 38, baseFat: 26,
    baseItems: [{ food: 'Salmon fillet', qty: '180g' }, { food: 'Asparagus', qty: '120g' }, { food: 'Brown rice, cooked', qty: '140g' }] },
  { id: 'd42', mealType: 'Dinner', diet: 'pescatarian', name: 'Baked Halibut & Wild Rice', baseCalories: 550, baseProtein: 42, baseCarbs: 50, baseFat: 16,
    baseItems: [{ food: 'Halibut fillet', qty: '180g' }, { food: 'Wild rice, cooked', qty: '160g' }, { food: 'Green beans', qty: '90g' }] },
  { id: 'd43', mealType: 'Dinner', diet: 'pescatarian', name: 'Herb Baked Snapper & Vegetables', baseCalories: 530, baseProtein: 40, baseCarbs: 42, baseFat: 18,
    baseItems: [{ food: 'Red snapper fillet', qty: '180g' }, { food: 'Roasted vegetables', qty: '150g' }, { food: 'Quinoa, cooked', qty: '100g' }] },
  { id: 'd44', mealType: 'Dinner', diet: 'omnivore', name: 'Roast Lamb & Root Vegetables', baseCalories: 610, baseProtein: 42, baseCarbs: 44, baseFat: 28,
    baseItems: [{ food: 'Roast lamb', qty: '180g' }, { food: 'Carrots', qty: '80g' }, { food: 'Parsnips', qty: '80g' }, { food: 'Potatoes', qty: '120g' }] },
  { id: 's41', mealType: 'Snack', diet: 'pescatarian', name: 'Tuna Lettuce Wraps', baseCalories: 190, baseProtein: 22, baseCarbs: 6, baseFat: 9,
    baseItems: [{ food: 'Tuna, canned in water', qty: '110g' }, { food: 'Light mayo', qty: '15g' }, { food: 'Lettuce cups', qty: '3' }] },
  { id: 's42', mealType: 'Snack', diet: 'pescatarian', name: 'Smoked Salmon Cucumber Bites', baseCalories: 200, baseProtein: 16, baseCarbs: 7, baseFat: 12,
    baseItems: [{ food: 'Smoked salmon', qty: '70g' }, { food: 'Cucumber slices', qty: '80g' }, { food: 'Cream cheese', qty: '20g' }] },
  { id: 's43', mealType: 'Snack', diet: 'omnivore', name: 'Grilled Chicken Strips', baseCalories: 210, baseProtein: 27, baseCarbs: 8, baseFat: 7,
    baseItems: [{ food: 'Grilled chicken breast strips', qty: '140g' }, { food: 'Honey mustard dip', qty: '20g' }] },
  { id: 's44', mealType: 'Snack', diet: 'omnivore', name: 'Roast Beef Roll-Ups', baseCalories: 210, baseProtein: 21, baseCarbs: 12, baseFat: 8,
    baseItems: [{ food: 'Lean roast beef', qty: '100g' }, { food: 'Lettuce', qty: '20g' }, { food: 'Whole-grain tortilla', qty: '1' }] },
  { id: 's45', mealType: 'Snack', diet: 'omnivore', name: 'Turkey & Apple Slices', baseCalories: 200, baseProtein: 18, baseCarbs: 20, baseFat: 6,
    baseItems: [{ food: 'Sliced turkey breast', qty: '100g' }, { food: 'Apple', qty: '1' }] },
];
